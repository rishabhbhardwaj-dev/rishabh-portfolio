...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      id="hero"
      className="relative min-h-screen md:min-h-screen w-full flex items-center justify-center pt-20 md:pt-24 pb-10 md:pb-0 px-6 overflow-hidden"
    ...
    >
      ...
      <div className="container mx-auto max-w-5xl flex flex-col items-center text-center z-10 relative">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 md:py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl mb-6 md:mb-12 shadow-[0_0_20px_rgba(255,255,255,0.05)] -translate-x-2 sm:-translate-x-4 md:-translate-x-6"
        >
          <span className="relative flex h-2.5 w-2.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-primary"></span>
          </span>
          <span className="text-xs md:text-sm font-medium text-gray-300">Available for new opportunities</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight mb-4 md:mb-8 leading-[1.1]"
        >
        ...
        <motion.h2
          ...
          className="text-xl md:text-3xl font-medium text-gray-300 mb-4 md:mb-8 tracking-wide"
        >
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-gray-400 max-w-2xl mb-8 md:mb-14 leading-relaxed font-light"
        >
        ...
        >
          <a
            href="#projects"
            className="group relative inline-flex items-center justify-center gap-3 px-7 md:px-8 py-3 md:py-4 rounded-full bg-white text-black font-semibold text-sm md:text-base transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.5)]"
          >
            View Projects
