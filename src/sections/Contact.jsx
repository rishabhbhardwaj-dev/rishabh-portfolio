  ...
  return (
    <section id="contact" className="py-16 md:py-32 px-6 relative z-10 w-full flex flex-col items-center">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="bg-white/5 border border-white/10 p-5 md:p-16 rounded-3xl backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center lg:text-left mb-6 md:mb-12">
              <h2 className="text-sm font-bold tracking-widest text-primary uppercase mb-2 md:mb-3">Get in Touch</h2>
              <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-3 md:mb-6">Let's build something amazing together.</h3>
              <p className="text-sm md:text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto lg:mx-0">
